...
task main()
{
	...
	bool secondDriverControl = false;
  ...
  while(true){
  	...
  	getJoystickSettings(joystick);
		...
		if (joy1Btn(12))
			secondDriverControl = true;
		else
			secondDriverControl = false;

  	//movement

		//if (!secondDriverControl)
  		setMovementPower(correctInputs(joystick.joy1_x2), correctInputs(joystick.joy1_y1));
  	//else
  		//setMovementPower(correctInputs(joystick.joy2_x2), correctInputs(joystick.joy2_y1));
